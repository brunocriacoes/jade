...
class Asaas
{
	...
	public function postPayments(
		...
		$multa = ($valor - 3.5) * 0.05;
		$juros_por_dia = 0.001;
		$dias_atraso = 30;
		$juros_mensal = $juros_por_dia * $dias_atraso;

		$juros_por_um_dia = ($valor - 3.5) * $juros_por_dia;

		$multa = number_format($multa, 2, ',', '.');
		$juros_por_um_dia = number_format($juros_por_um_dia, 2, ',', '.');
...
JUROS MENSAL APÓS 1 DIA DE VENCIMENTO R$ $juros_por_um_dia\r\n
